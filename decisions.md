...
- Halts subjob until they arrive
- Options:
...
- Do you want to use the recommendation of this thing to speed you up?
- Options:
    - Take advice
        - All subjobs lose a shift or two of work
    - Ignore the AI
        - Nothing happens

Worker took an off day

- For that shift the subjob is not worked
- Options:
    - Find a replacement
